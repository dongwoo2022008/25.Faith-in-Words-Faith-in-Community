...
The finding speaks to three literatures. The first is the work on social capital and finance, which has shown that trust and civic networks shape financial development and household financial behavior (Guiso, Sapienza and Zingales, 2004) and that religion in particular is associated with attitudes conducive to economic cooperation (Guiso, Sapienza and Zingales, 2003; Iannaccone, 1992). That literature has worked almost entirely at the level of regions and countries. The second is the finance literature on religiosity, which is likewise regional: county adherence rates predict lower mortgage delinquency (Li and Ucar, 2022) and less mortgage misrepresentation (Conklin, Diop and Qiu, 2022). Individual-level evidence is scarce because individual religion is rarely observed in loan files; here it is, twice. And I find that the individual signal is not the regional one seen from closer up. Local religiosity does not protect borrowers in this unsecured market — if anything it is associated with slightly higher default within state — while individual affiliation does, and the individual effect is amplified rather than explained by the local one. The third literature is the work on borrower text in credit markets (Netzer et al., 2019; Nowak, Ross and Yencha, 2018; Sanz-Guerrero and Arroyo, 2024), which has established that words predict default and has been less interested in which words carry information of their own rather than proxying for circumstance. Religious language, it turns out, mostly proxies — but not entirely, and the part that does not is the part one would predict from theory: descriptions that report religious *practice* rather than merely invoking faith behave like the affiliation signal.
...
Table 2 reports the affiliation estimates. In the full terminal sample the odds ratio is 0.69 (clustered standard error on the log-odds 0.041; p ≈ 7 × 10⁻¹⁹), an average marginal effect of −4.8 percentage points against a base default rate of 20 percent. The estimate is 0.61 for loans issued in 2008–2014 and 0.74 for 2015–2018; the effect is smaller in the later, lower-default years but does not fade, which matters because it means the finding is not a property of the platform's early, self-selected borrowers. The one-sided Holm-adjusted p-value is below 10⁻¹⁸.
...
Table 7 tests the income-stability alternative from the other side. Local unemployment matters for default in the expected way — a standard deviation higher rate at origination raises the odds by 9.5 percent, a standard deviation larger rise over the loan's life by 3.2 percent — but the affiliation advantage does not widen when unemployment rises (interaction 0.98, p = 0.69) or when it is high (0.95, p = 0.38), and it is not monotone across shock terciles (0.58, 0.74, 0.70). I would not lean on this too hard. The sample period is mostly a recovery, the average "shock" is a fall in unemployment, and when I run the same interaction for teachers and government employees as a positive control, their advantage does not widen either (1.04, p = 0.08; 1.01, p = 0.71). The honest reading is that the shocks in these years are too small to reveal an income-stability mechanism for any occupation, so the test cannot reject it; what it can say is that the affiliation effect is not visibly a shock-absorption effect, while it is visibly a community-density effect.

## 5.5 Individual religion and local religion

The religiosity literature in finance is almost entirely about places, and it is worth asking whether my signals are the same thing seen from closer up. They are not. Local religiosity does not do in this market what it does in mortgage markets. Within state, borrowers from more religious ZIP3 areas default slightly *more* (odds ratio 1.04 per standard deviation of adherence, 1.06 per standard deviation of congregation density), and the evangelical share is unrelated to default. I do not have an explanation and offer none; unsecured consumer credit differs from mortgage credit in ways that may matter, and the within-state residual variation in religiosity is correlated with income and urbanicity in ways that state fixed effects and my income control may not fully absorb. I flag it as a contrast with the county literature rather than a contradiction of it. What the contrast makes clear is that whatever protects the affiliated borrower is not a property of religious places. It is a property of belonging to a religious institution, and it is amplified by the density of such institutions rather than replaced by it.
...
Nowak, A., Ross, A., & Yencha, C. (2018). Small business borrowing and peer-to-peer lending: Evidence from Lending Club. *Contemporary Economic Policy*, 36(2), 318–336. [서지 미확인 — 확인 필요]
...
Sanz-Guerrero, M., & Arroyo, J. (2024). Credit risk meets large language models: Building a risk indicator from loan descriptions in P2P lending. [서지 미확인 — 확인 필요]
...
| Affiliation, low / mid / high adherence tercile | 0.708 / 0.830 / 0.585 | | all <0.01 | n = 890 / 974 / 1,241 |
