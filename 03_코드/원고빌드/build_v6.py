...
body=open("manuscript_v6.md").read(); tables=open("ms_tables_v6.md").read()
# tables after references, new page
full=body.rstrip()+"\n\n\\newpage\n\n"+tables
open("manuscript_v6_full.md","w").write(full)
subprocess.run(["pandoc","-f","markdown-tex_math_dollars","manuscript_v6_full.md","-o","manuscript_v6.docx","--resource-path=.","-V","geometry:margin=2.5cm"],check=True)
doc=Document("manuscript_v6.docx")
# base font
...
doc.save("manuscript_v6.docx")
subprocess.run(["soffice","--headless","--convert-to","pdf","--outdir","render","manuscript_v6.docx"],check=True,capture_output=True)
print("built")
