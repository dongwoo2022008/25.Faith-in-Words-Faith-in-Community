...
body=open("manuscript_v3.md").read(); tables=open("ms_tables_v3.md").read()
# tables after references, new page
full=body.rstrip()+"\n\n\\newpage\n\n"+tables
open("manuscript_v3_full.md","w").write(full)
subprocess.run(["pandoc","-f","markdown-tex_math_dollars","manuscript_v3_full.md","-o","manuscript_v3.docx","--resource-path=.","-V","geometry:margin=2.5cm"],check=True)
...
doc.save("manuscript_v3.docx")
subprocess.run(["soffice","--headless","--convert-to","pdf","--outdir","render","manuscript_v3.docx"],check=True,capture_output=True)
print("built")
