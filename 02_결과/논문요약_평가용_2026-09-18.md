...
1. 종교가 대출 파일에 들어오는 두 경로를 구분하고, 같은 자료·같은 통제 아래 두 경로가 반대 부호임을 보인다. 선행연구(Netzer, Lemaire & Herzenstein 2019, JMR)는 종교 언어를 부도 관련 어휘 중 하나로만 다뤤고, 종교 소속을 개인 수준에서 관측한 신용 연구는 확인되지 않는다.
