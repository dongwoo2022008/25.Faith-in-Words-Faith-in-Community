...
body=open("manuscript_v10.md").read()
# tables after references, new page
full=body
open("manuscript_v10_full.md","w").write(full)
subprocess.run(["pandoc","-f","markdown-tex_math_dollars","manuscript_v10_full.md","-o","manuscript_v10.docx","--resource-path=.","-V","geometry:margin=2.5cm"],check=True)
doc=Document("manuscript_v10.docx")
# base font
...
doc.save("manuscript_v10.docx")
subprocess.run(["soffice","--headless","--convert-to","pdf","--outdir","render","manuscript_v10.docx"],check=True,capture_output=True)
print("built")
