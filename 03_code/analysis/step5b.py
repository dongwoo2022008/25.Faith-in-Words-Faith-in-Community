...
num=['int','fico','linc','dti','lamt','term60']; cat=['grade','yr','home','ver','term60']
...
r=minimize(dual, np.zeros(Zc.shape[1]), jac=grad, method='L-BFGS-B', options={'maxiter':50000,'gtol':1e-9,'ftol':1e-15,'maxcor':50})
